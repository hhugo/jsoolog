...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c275abc79b34faaf396f9fa4942c263) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hhugo/jsoolog";
          synopsis = "Logger for js_of_ocaml";
          description =
            Some
              [
                 OASISText.Para
                   "Jsoolog (Js_of_ocaml logger) is a library managing Lwt logger for application running in the browser."
              ];
          categories = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Jsoolog";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
          ...
          plugins =
            [(`Extra, "StdFiles", Some "0.4"); (`Extra, "META", Some "0.4")];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "`Ë¦\142~êe\137¤HoõP\129Â ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
